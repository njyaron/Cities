package 
{
	...
	public class Soldier extends Entity
	{
		...
		public function Soldier(b,c)
		{
			super(); //run default constructor
			this.addEventListener(Event.ENTER_FRAME,changeLoc);
		...
		override public function kill():void //THIS IS OVERRIGHT!!!
		{
			...
			{
				this.removeEventListener(Event.ENTER_FRAME,changeLoc);
			}
		}
